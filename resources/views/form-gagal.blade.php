            ...
            <div class="max-w-2xl mx-auto text-center mb-20">
                <h1 class="font-heading text-5xl sm:text-6xl tracking-xs text-white mb-6">
                    <section class="relative py-12 lg:py-24 bg-teal-900 overflow-hidden"><img
                        ...
                        <div class="container mx-auto px-4 relative">
                            <div class="max-w-2xl mx-auto text-center mb-20">
                                <h1 class="font-heading text-5xl sm:text-6xl tracking-xs text-white mb-6">Gagal</h1>
                                <p class="text-lg text-white opacity-80">Form Gagal Diajukan!</p>
                                <p class="text-lg text-white opacity-80">Silakan isikan kembali formulir sebelumnya.</p>
                            </div>
