        ...
        @if ($currentStep === 5)
            <div class="p-4 rounded-lg shadow-md mt-5 bg-white space-y-6">
                ...
                <div class="max-w-xl mx-auto text-center">
                  <p class="text-gray-700">Silakan periksa kembali data yang Anda isi sebelum mengirim permohonan.</p>
                  <p class="text-gray-700">Jika semua data sudah benar, silakan klik tombol <strong>Submit</strong> di bawah untuk mengirim
                    permohonan.</p>
                </div>
            </div>
        @endif
